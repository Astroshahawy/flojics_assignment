...
import 'package:flojics_assignment/src/presentation/screens/09-manage-products/add-products-screen/widgets/field_section.dart';
...
class DescriptionField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FieldSection(
      ...
      isDescription: true,
      child: TextFormField(
        controller: ManageProductsCubit.get(context).productDescriptionController,
